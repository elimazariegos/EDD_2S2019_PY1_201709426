...
${OBJECTDIR}/Generador_Repore.o: Generador_Repore.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Generador_Repore.o Generador_Repore.cpp
...
${OBJECTDIR}/Lista_String.o: Lista_String.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Lista_String.o Lista_String.cpp
...
${OBJECTDIR}/Nodo_String.o: Nodo_String.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Nodo_String.o Nodo_String.cpp
